...
const Hero = () => {
  return (
    <div className="relative bg-gradient-to-br from-blue-50 to-teal-50 py-24 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 max-w-xl">
            <h1 className="text-4xl md:text-5xl font-heading font-bold tracking-tight text-gray-900 leading-tight">
              <span className="text-primary">AI-Powered</span> Talent Matching for the Future of Work
            </h1>
            <p className="text-lg text-gray-700">
              Project Guild uses artificial intelligence to pre-vet candidates and organize them into specialized 
              <span className="text-primary font-medium"> Guilds</span>, making talent discovery more efficient and meaningful.
            </p>
            
            <div className="space-y-4">
              <div className="flex items-start">
                <Check className="text-secondary mr-2 mt-1" />
                <span>Comprehensive assessment of technical skills, soft skills, and work preferences</span>
              </div>
              <div className="flex items-start">
                <Check className="text-secondary mr-2 mt-1" />
                <span>Smart categorization into relevant industry and skill-based guilds</span>
              </div>
              <div className="flex items-start">
                <Check className="text-secondary mr-2 mt-1" />
                <span>Access pre-vetted talent pools with verified capabilities</span>
              </div>
            </div>
          ...
          <div className="relative">
            <div className="bg-white rounded-lg shadow-xl p-8 relative z-10">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-xl font-semibold ml-3">AI Interviewer</h2>
              </div>
            ...
            <div className="absolute bottom-12 -left-8 w-40 h-40 bg-teal-500 rounded-full opacity-10 blur-3xl"></div>
          </div>
        </div>
      </div>
    </div>
