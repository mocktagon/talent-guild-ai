      ...
      <div className="container">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-heading font-bold mb-6">
            How Project Guild Works
          </h2>
          <p className="text-gray-600 text-lg">
            Our AI-powered platform streamlines talent assessment and matching, 
            creating specialized guilds of pre-vetted professionals.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          <div className="bg-white rounded-xl p-6 shadow-md relative">
            ...
            <h3 className="text-xl font-bold mb-3">Candidate Registration</h3>
            <p className="text-gray-600">
              Professionals create a profile highlighting their experience, 
          ...
          <div className="bg-white rounded-xl p-6 shadow-md relative">
            ...
            <p className="text-gray-600">
              Our AI conducts a comprehensive assessment of technical skills, 
          ...
          <div className="bg-white rounded-xl p-6 shadow-md relative">
            ...
            <h3 className="text-xl font-bold mb-3">Guild Placement</h3>
            <p className="text-gray-600">
              Candidates are placed into specialized guilds based on their 
              assessment results and verified capabilities.
            </p>
            <div className="absolute top-0 right-0 h-1 w-1/3 bg-primary rounded-tr-xl"></div>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-md relative">
            ...
            <h3 className="text-xl font-bold mb-3">Recruiter Discovery</h3>
            <p className="text-gray-600">
              Companies access pre-vetted talent pools organized by skill, 
              ...
              <div className="relative">
                <div className="bg-white/20 backdrop-blur-sm rounded-lg p-6 mb-4">
                  <div className="flex items-center mb-3">
                    ...
                    <div className="text-sm">AI Assessment</div>
